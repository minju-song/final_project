...
public class AttachmentServiceImpl implements AttachmentService {
	 ...
	 * @return
	 */
	public List<AttachmentVO> uploadFiles(MultipartFile[] uploadFiles, String type) { //@RequestPart MultipartFile[배열로 받는다(여러파일 동시에)] 파일 업로드 어노테이션 multipart/form-data로 넘어온 데이터 처리
